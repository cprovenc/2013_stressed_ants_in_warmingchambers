...
# Metadata and loading in dataset   
### Name and contact info: Curits Provencher, cprovenc@uvm.edu   
### Study name: Foraging ant workers experience sub-lethal stress under experimental climate warming at both northern and southern range boundaries	   
### Financial support: National Science Foundation, Division of Environmental Biology (1136644)   
### Methods of data collection:    
### Experimental units for each variable:
- Sample: 3 ants
- Bait Temperature: degrees Celsius
- RNA concentration: ng/uL
- Gene cycle threshold: Fluorescent readings taking at 0.1 threshold during cyles 9-15
- cDNA concentration: ng/uL
- H~2~O and cDNA volume: uL
#Data layout and structure:
```{r data and metadata}
#warm<-read.csv("2015_warming_prelim.csv") #reading in the data set
warm<-read.csv("../Data//20160211_DF_Aph_Cham_LNSampling.csv")
